...
// позволяет отправить действие диспетчеру и изменить состояние приложения
// библиотеки redux Они используются для доступа к хранилищу Redux и для отправки действий соответственно.
